...
### Surface & Border
- **Light Cream** (`#eceae4`): Subtle fills, skeletons, hover tints — not primary borders.
- **Warm Border** (`#b8aea0`): Default structural borders — cards, dividers, sidebar, headers, inputs (`tailwind`: `warm-border`).
